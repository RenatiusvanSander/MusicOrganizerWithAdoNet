...
// Install NuGet System.Reactive for class Observable
...
namespace MusicOrganizer.ViewModels
{
    ...
    /// <summary>
    /// Provides functionality to provide errors for the object if it is in an
    /// invalid state.
    /// </summary>
    /// <typeparam name="T">The type of this instance.</typeparam>
    public abstract class NotifyDataErrorInfo<T> : ViewModelErrorHandler,
        ...
        where T : NotifyDataErrorInfo<T>
    {
        ...
        protected virtual void OnPropertyChanged([CallerMemberName] string propertyName = null)
        {
            ...
            // Apply rules on OnPropertyChanged.
            else
            {
        ...
        private void ApplyRules(string propertyName)
        {
            ...
            List<object> propertyErrors = rules.Apply((T)this, propertyName)
                .ToList();
